...
<header>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <form action="" method="post">
                        <input class="btn navbar-btn" type="submit" value="Deconnexion" name="disconnect">
                    </form>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div class="container-fluid text-right">
        <strong>Hello <?php if (!isset($_SESSION['loginname'])) {echo 'wilder';} else {echo $_SESSION['loginname'];}?> !</strong>
    </div>
</header>
